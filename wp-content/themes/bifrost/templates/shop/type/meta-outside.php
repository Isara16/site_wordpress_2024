...
if ($neuron_posts_hover_visibility != 'hide' && $neuron_posts_hover_animation) {
    $bifrost_shop_meta_outside_class .= ' o-neuron-hover--' . $neuron_posts_hover_animation;
}
...
<div class="<?php echo esc_attr($bifrost_shop_meta_outside_class) ?>">
    <?php if (has_post_thumbnail() && $neuron_posts_meta_thumbnail == 'yes') : ?>
    ...
    <div class="o-neuron-hover__body o-neuron-post__content">
        <div class="o-neuron-hover__body-meta">
            <?php if ($neuron_posts_meta_title == 'yes') : ?>
                <h5 class="o-neuron-hover__body-meta__title o-neuron-post__title"><a href="<?php the_permalink() ?>"><?php echo esc_attr($product->get_title()); ?></a></h5>
            <?php endif; ?>
            <?php if ($neuron_posts_meta_price == 'yes') : ?>
                <h6 class="o-neuron-hover__body-meta__price o-neuron-post__price"><?php wc_get_template_part('woocommerce/loop/price') ?></h6>
            <?php endif; ?>
        </div>
    </div>
</div>